    ...
    def handle_map_editor(self, event):
        ...
        if not self.ui.in_group_editor and not self.ui.in_group_selector:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if event.button == 1:
                    self.clicking = True
                    self.mpos_scaled_onclick = (self.mpos_scaled[0] + self.scroll[0],
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if mods & pygame.KMOD_CTRL:
                    ...
                    if event.key == pygame.K_e:
                        t = str(input("tag to edit : "))
                        i = str(input("remove info : "))
                        self.delete_info(t, i)

                    if event.key == pygame.K_a:
                        g = str(input("group to edit: "))
                        t = str(input("remove tag: "))
                        self.remove_tag_from_group(g, t)

                    if event.key == pygame.K_t:
                        i = str(input("group id to toggle global: "))
                        self.toggle_group_global(i)
...
class UI:
    ...
    # TODO Connecting the the UI with the group logic
